...
So we do not overwhelm the open-meteo API, we have made the climate data used in this tutorial available as a Community Data resource on CyVerse [here](https://de.cyverse.org/data/ds/iplant/home/shared/NEON/ESA2024/forecasting_beetles_workshop?type=folder&resourceId=af152ca6-dc9b-11ee-aacd-90e2ba675364).
...
Are these scores better than our null models? Here, we will score the `mod_mean` and `mod_naive`, and combine the null model scores with the scores for our `best_lm` forecast above. Then we can compare. 
